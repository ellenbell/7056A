...
\chapter{Workshop 4 - Introduction to Design and Analysis of Experiments}\label{differences}
...
Now load your script from Practical 2, Chapter \ref{differences}, load the \texttt{tidyverse} package and create a \texttt{chickens} object containing the \texttt{pecking\_rates.csv}.
