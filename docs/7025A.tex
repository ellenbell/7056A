...
\hypertarget{workshop-67---multivariate-linear-modelling}{%
\chapter{Workshop 6/7 - Multivariate Linear Modelling}\label{workshop-67---multivariate-linear-modelling}}
...
\hypertarget{practical-6---multiple-linear-regression}{%
\section{Practical 6 - Multiple Linear Regression}\label{practical-6---multiple-linear-regression}}
...
\tightlist
\item
  What do the leverage values are indicate?
\item
...
\item
  lansdscape\_type: Surrounding landscape (1 = arable, 2 = grassland, 3 = heath, 4 = wood)
\item
