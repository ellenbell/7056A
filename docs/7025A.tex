...
\url{https://www.datanovia.com/en/lessons/repeated-measures-anova-in-r/\#google_vignette}
...
\hypertarget{data-set-2-bird-metabolism}{%
\section{Data set 2: Bird Metabolism}\label{data-set-2-bird-metabolism}}
