...
Now load your script from Practical 4, Chapter 4, load the `tidyverse` package and create a `chickens` object containing the `pecking_rates.csv`. 
...
pecking_rates_box <- ggplot(data = chickens, aes(x = light, y = pecking_rates, fill = sex)) 
pecking_rates_box # Print the object your plot is stored in to view it
```
