...
1) __Logarithmic:__ remember that the logarithm of a number x is the number to which 10 (or e) has to be raised in order to give x: e.g. log10(100) = 2 since 100 = 102; log10(1000) = 3 since 1000 = 103, and so on.
