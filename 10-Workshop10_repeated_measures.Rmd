...
Log into posit Cloud and return to the classroom work space, open the project called __Workshop_10__. Set up your script and install and load the following packages; `tidyverse`and `rstatix`.
